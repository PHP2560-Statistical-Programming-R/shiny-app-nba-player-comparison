...
ui <- dashboardPage(skin = "purple",
                    ...
                    dashboardSidebar(
                      ...
                      sidebarMenu(
                        ...
                        menuItem("Compare", tabName = "compare", icon = icon("bar-chart"), badgeLabel = "cool", badgeColor = "green"),
                    ...
                    dashboardBody(
                      tabItems(
                        tabItem(tabName = "instructions",
                                ...
                                h4("7. Enjoy!"),
                                br(),
                                h4("NOTE: Expansion and explanation of the abbreviations:",
                        ...
                        tabItem(tabName = "contact",
                                ...
                                h4("Ozan Adıgüzel", 
                                   ...
                                   br(),
                                   a("GitHub", href="https://github.com/ozan147")
                                   )
                                )
                      )
